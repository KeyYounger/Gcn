...
from model.get_adj import get_adj
...
adj_mx, distance_mx, edge_index, val = get_adjacency_matrix(adj_filename, num_of_vertices, id_filename)
# adj_mx = get_adj(edge_index, val, num_of_vertices)
...
#     'layer2': [64, 32]
# }
# net = make_model(DEVICE, args_layers, adj_mx, num_for_predict, len_input, num_of_vertices)
